...
1. `cd ardupilot`
2. `git checkout Copter-3.4.3` for ArduCopter or `git checkout ArduPlane-3.7.1` for ArduPlane or `git checkout APMrover2-3.1.0` for ArduRover
...
4. `git checkout Copter-3.4.3` for ArduCopter or `git checkout ArduPlane-3.7.1` for ArduPlane or `git checkout APMrover2-3.1.0` for ArduRover
